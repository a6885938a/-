...
// cnpm install --save-dev gulp-sass gulp-uglify gulp-autoprefixer gulp-minify-css gulp-concat gulp-rename del run-sequence gulp-imagemin imagemin-pngquant gulp-tinypng-compress gulp-cache

//默认任务
gulp.task('default', ['clean'], function() {
    gulp.start('minifycss', 'minify-js')
});
