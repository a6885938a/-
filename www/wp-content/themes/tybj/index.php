...
<head>
    ...
    <link rel='stylesheet' href='<?=ty_of?>dist/css/tybj.css?v=8a2bd5cb6b'>
    <link rel="stylesheet" type="text/css" href="<?=ty_of?>public/css/swiper.min.css">
    <?php include('header_js.php');?>
    <script src='<?=ty_of?>dist/js/loadjs.js?v=2c2e8657b0'></script>

</head>
 <img id="img" class="v-banner hidden-xs mt-50" src="<?=ty_img?>dist/images/21.jpg<?=$A_webps?>?v=aa80d23b76?v=aa80d23b76?v=aa80d23b76?v=aa80d23b76?v=aa80d23b76?v=aa80d23b76" >
<body class="loaded">
<div class="site">
            ...
            <main class="site-main-1">
                ...
                <div id="home" class="section block-primary position-r align-c-xs-max" style="  overflow: hidden;">
                    <div class="video_play">
                        <video id="video" autoplay loop muted="muted" poster="<?=ty_img?>dist/images/video_img.jpg<?=$A_webps?>?v=3ee69f60d5?v=3ee69f60d5?v=3ee69f60d5?v=3ee69f60d5?v=3ee69f60d5?v=3ee69f60d5" webkit-playsinline />
                        </video>
                    </div>
                    <div class="container">
                            ...
                            <div class="col-sm-12">
                                <div class="col-inner op0" data-scroll-reveal="enter left over 1.5s " >
                                    <div class="section-heading ">
                                        <img id="img" class="v-banner hidden-xs mt-50" src="<?=ty_img?>dist/images/wenzi.png?v=84ae28862f" >
                                           <img class="v-banner visible-xs mt_20" src="<?=ty_img?>dist/images/h-wenzi.png?v=410f92096d" >
                                    </div>
                                    <!-- .section-heading -->
                                </div>
                            </div>
                                        ...
                                        <div class="grid">
                                            <div class="figure">
                                                <figure class="effect-apollo">
                                                    <img class="lazy" src="<?=ty_img?>dist/images/loading.jpg<?=$A_webps?>?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70" data-original="<?=ty_img?>dist/images/01.jpg<?=$A_webps?>?v=72aef8e273?v=72aef8e273?v=72aef8e273?v=72aef8e273?v=72aef8e273?v=72aef8e273" alt="img18">
                                                    <figcaption>
                                ...
                                <div class="r ver-view" style="float:left;">
                                    <a class="mb10" href="<?php echo get_category_link( 7 ) ?>">
                                        <div class="grid">
                                            <div class="figure">
                                                <figure class="effect-apollo">
                                                    <img class="lazy" src="<?=ty_img?>dist/images/loading.jpg<?=$A_webps?>?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70" data-original="<?=ty_img?>dist/images/02.jpg<?=$A_webps?>?v=cf4fc25f29?v=cf4fc25f29?v=cf4fc25f29?v=cf4fc25f29?v=cf4fc25f29?v=cf4fc25f29" alt="img18">
                                    ...
                                    <a class="mb10" href="<?php echo get_category_link( 8 ) ?>" >
                                        <div class="grid">
                                            <div class="figure">
                                                <figure class="effect-apollo">
                                                    <img class="lazy" src="<?=ty_img?>dist/images/loading.jpg<?=$A_webps?>?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70" data-original="<?=ty_img?>dist/images/03.jpg<?=$A_webps?>?v=1723ab468d?v=1723ab468d?v=1723ab468d?v=1723ab468d?v=1723ab468d?v=1723ab468d" alt="img18">
                                                    <figcaption>
                                    ...
                                    <div class="swiper-container swiper">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                   <a>
                                                <img class="swiper-lazy" data-src="<?=ty_img?>dist/images/w-1.jpg<?=$A_webps?>?v=01ec65e37f?v=01ec65e37f?v=01ec65e37f?v=01ec65e37f?v=01ec65e37f?v=01ec65e37f">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                            <a >
                                                <img class="swiper-lazy" data-src="<?=ty_img?>dist/images/w-2.jpg<?=$A_webps?>?v=8eae48e0dc?v=8eae48e0dc?v=8eae48e0dc?v=8eae48e0dc?v=8eae48e0dc?v=8eae48e0dc">
                                                </a>
                                            </div>
                                        </div>
                                        <!-- Add Pagination -->
              ...
              <?php $category = get_the_category();//定义分类目录?>              
                <li class="col-xs-12 col-sm-6 col-md-4 op0" data-scroll-reveal="enter top over 1s ">
                    <a href="<?php the_permalink(); ?>">
                        <div class="goods-pic">
                            <figure><img class="lazy" src="<?=ty_img?>dist/images/loadbg.jpg<?=$A_webps?>?v=062bdb31aa?v=062bdb31aa?v=062bdb31aa?v=062bdb31aa?v=062bdb31aa?v=062bdb31aa"  data-original="<?php bloginfo('template_url');?>/timthumb.php?src=<?php echo post_thumbnail_src(); ?>&h=238&w=238&zc=1""></figure>
                        </div>
                        <h3><?php the_title(); ?></h3>
                    </a>
                </li>
                            ...
                            <div class="col-sm-6 col-md-5">
                                <div class="col-inner">
                                    <div class="icon-box _left">
                                        <div class="icon-box-media" data-scroll-reveal="enter left over 1s and move 20px"> <img class="lazy" src="<?=ty_img?>dist/images/loading.jpg<?=$A_webps?>?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70" data-original="<?=ty_img?>dist/images/picture/cook_1.png?v=d677cd94b9" alt=""> </div>
                                    ...
                                    <div class="icon-box _left">
                                        <div class="icon-box-media" data-scroll-reveal="enter left over 1s and move 20px after 0.2s"> <img class="lazy" src="<?=ty_img?>dist/images/loading.jpg<?=$A_webps?>?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70" data-original="<?=ty_img?>dist/images/picture/cook_2.png?v=ea700dcdaa"> </div>
                                        <div class="icon-box-heading">
                                            <h4>邮箱地址</h4>
                                        </div>
                                    ...
                                    <div class="icon-box _left">
                                        <div class="icon-box-media" data-scroll-reveal="enter left over 1s and move 20px after 0.4s"> <img class="lazy" src="<?=ty_img?>dist/images/loading.jpg<?=$A_webps?>?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70?v=7465ce9c70" data-original="<?=ty_img?>dist/images/picture/cook_3.png?v=a4ecfc9c1c"> </div>
                                        <div class="icon-box-heading">
                                            <h4>工厂店址</h4>
