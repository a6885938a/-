...
<!-- .textgood1{ background: url(../images/21.jpg?v=e22ce39297); } -->
</head>
 <img id="img" class="v-banner hidden-xs mt-50" src="<?=ty_img?>dist/images/21.jpg?v=e22ce39297" >
<body class="loaded">
<div class="site">
                        ...
                        <div class="row section-content m-t-60-sm-min">
                            <div class="col-sm-6 col-md-5">
                                <div class="col-inner">
                                    ...
                                    <div class="icon-box _left">
                                        <div class="icon-box-media" data-scroll-reveal="enter left over 1s and move 20px after 0.2s"> <img class="lazy" src="<?=ty_img?>dist/images/loading.jpg?v=7465ce9c70" data-original="<?=ty_img?>dist/images/picture/cook_2.png?v=ea700dcdaa"> </div>
                                        <div class="icon-box-heading">
                                            <h4>邮箱地址</h4>
                                        </div>
