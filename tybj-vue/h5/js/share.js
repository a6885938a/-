...
var WxShare = function(options) {
    ...
    this.init();
    this.f = typeof urlObj !== 'undefined' ? urlObj.f ? urlObj.f : "" : ""
};
WxShare.prototype = {
    ...
    setOriOptions: function() {
        ...
        this.timeLineOptions = {
            ...
            success: function() {
                if (typeof _hmt !== 'undefined') {
                    _hmt.push(["_trackEvent", "shareTimeLine" + _this.f, "click", "shareTimeLine" + _this.f]);
                }
                _success && _success();
            }
        };
        this.appMessageOptions = {
            success: function() {
                if (typeof _hmt !== 'undefined') {
                    _hmt.push(["_trackEvent", "shareAppMessage" + _this.f, "click", "shareAppMessage" + _this.f]);
                }
                _success && _success();
            }
        };
