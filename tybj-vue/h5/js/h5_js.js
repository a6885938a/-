...
Main.prototype = {
	...
	eventHandle: function() {
		...
		$(window).on("touchmove", function(n) {
			...
			return n.curIndex >= 7 ? !1 : (-1 === navigator.userAgent.indexOf("Android") && document.getElementById("J_Eye").play(), n.rotate -= 30, $("#J_Btn").css({
				"-webkit-transform": "rotate(" + n.rotate + "deg)"
			}), n.curIndex++, $("#J_BgBox .bg_1,#J_BgBox .bg_2,#J_BgBox .bg_3").css("-webkit-transform", "translateX(-" + 100 * n.curIndex / 100 + "%)"), $(".salBox").hide(), $("#J_Box" + n.curIndex).css("display", "block"), n.reset(), void(7 == n.curIndex && n.sucInfo()))
	...
	auto: function(n, t, i, e, o, a) {
		function s() {
			...
			r % e === 0 && (n.removeClass(t + i + " " + t + (d - 1)).addClass(t + d), d++), r++, i >= d ? window.requestAnimFrame(s) : o ? (d = 0, window.requestAnimFrame(s)) : a && a()
		}
		var d = 1,
			r = 0;
		s()
	...
	submitInfo: function() {
		var n = $("#J_Name").val(),
			t = $("#J_Phone").val(),
			i = $("#J_Email").val();
		if (!n || !t || !i) return alert_v("请填写完整信息"), !1;
		var e = this,
			o = new Loading("提交中").show();
		$.ajax({
	...
	sucInfo: function() {
		$(".salBox").hide(), $("#J_Box7").css("display", "block"), $("#J_Btn").hide();
		var n = this;
		setTimeout(function() {
